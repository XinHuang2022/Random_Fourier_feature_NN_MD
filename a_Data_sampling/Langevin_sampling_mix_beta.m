	...
	function Langevin_sampling_test = Langevin_sampling_mix_beta( beta_1, beta_2, dim, alpha, gamma, R_a, R_c, sigma_a, sigma_c, h_x_sample, M_sp, Num_replica, Num_parallel_worker, L_x_vectorize )
		...
		filename = "..\d1_Visualisation_and_Data_Storage\Data_saved\Sample_store\Langevin_sample_store_V_general_mix_beta" + "_dim=" + dim + "_Msp=" + M_sp + "_Num_rep=" + Num_replica + "_Delta_t_sample=" + Delta_t_sample + "_dt=" + h_x_sample + ".csv";

	...
	function Langevin_sampling_test = Langevin_sampling_one_beta( beta, dim, alpha, gamma, R_a, R_c, sigma_a, sigma_c, h_x_sample, M_sp, Num_replica, Num_parallel_worker, N, Training_data_store_path )
